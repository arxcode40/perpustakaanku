			...
			<div class="align-items-center card-header d-flex">
				...
				<div class="dropdown me-1">
					...
					<ul class="dropdown-menu dropdown-menu-end">
						...
						<li>
							<a class="dropdown-item" href="<?= base_url(array('buku', 'laporan')) ?>" target="_blank">
				...
				<a class="btn btn-primary btn-sm shadow" href="<?= base_url(array('buku', 'tambah')) ?>">
							...
							<?php foreach ($books as $book): ?>
								<tr class="align-middle">
									...
									<td class="text-nowrap">
										<a class="btn btn-primary btn-sm shadow" href="<?= base_url(array('buku', 'ubah', html_escape($book['id']))) ?>">
