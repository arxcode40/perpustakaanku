			...
			<div class="align-items-center card-header d-flex">
				...
				<div class="dropdown me-1">
					...
					<ul class="dropdown-menu dropdown-menu-end">
						...
						<li>
							<a class="dropdown-item" href="<?= base_url(array('anggota', 'laporan')) ?>" target="_blank">
				...
				<a class="btn btn-primary btn-sm shadow" href="<?= base_url(array('anggota', 'tambah')) ?>">
							...
							<?php foreach ($members as $member): ?>
								<tr class="align-middle">
									...
									<td class="text-nowrap">
										<a class="btn btn-primary btn-sm shadow" href="<?= base_url(array('anggota', 'ubah',html_escape($member['id']))) ?>">
