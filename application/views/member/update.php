			...
			<div class="card-body">
				<div class="mb-3 row">
					...
					<div class="col-md-9 col-lg-10">
						<input class="form-control" disabled="disabled" id="memberCode" type="text" value="<?= html_escape(set_value('id', $member['member_id'])) ?>" />
					</div>
				</div>
				<div class="mb-3 row">
					...
					<div class="col-md-9 col-lg-10">
						<input autofocus="autofocus" class="form-control <?= form_error('name') === '' ?: 'is-invalid' ?>" id="memberName" name="name" placeholder="Masukkan nama anggota" type="text" value="<?= html_escape(set_value('name', $member['member_name'])) ?>" />
				...
				<fieldset class="mb-3 row">
					...
					<div class="col-md-9 col-lg-10">
						<div class="form-check form-check-inline">
							<input class="form-check-input" <?= set_radio('gender', 'Laki-laki', $member['member_gender'] === 'Laki-laki') ?> id="memberGenderMale" name="gender" type="radio" value="Laki-laki" />
							<label class="form-check-label" for="memberGenderMale">Laki-laki</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" <?= set_radio('gender', 'Perempuan', $member['member_gender'] === 'Perempuan') ?> id="memberGenderFemale" name="gender" type="radio" value="Perempuan" />
				...
				<div class="mb-3 row">
					...
					<div class="col-md-9 col-lg-10">
						<input class="form-control <?= form_error('email') === '' ?: 'is-invalid' ?>" id="memberEmail" name="email" placeholder="Masukkan email anggota" type="email" value="<?= html_escape(set_value('email', $member['member_email'])) ?>" />
				...
				<div class="mb-3 row">
					...
					<div class="col-md-9 col-lg-10">
						<input class="form-control <?= form_error('phone') === '' ?: 'is-invalid' ?>" id="memberPhone" name="phone" placeholder="Masukkan nomor telepon" type="tel" value="<?= html_escape(set_value('phone', $member['member_phone'])) ?>" />
				...
				<div class="row">
					...
					<div class="col-md-9 col-lg-10">
						<textarea class="form-control <?= form_error('address') === '' ?: 'is-invalid' ?>" id="memberAddress" name="address" placeholder="Masukkan alamat anggota"><?= html_escape(set_value('address', $member['member_address'])) ?></textarea>
						<?= form_error('phone', '<div class="invalid-feedback">', '</div>') ?>
					</div>
				</div>
			</div>
