				...
				<fieldset class="mb-3 row">
					...
					<div class="col-md-9 col-lg-10">
						<div class="form-check form-check-inline">
							<input class="form-check-input" <?= set_radio('gender', 'Laki-laki', $member['gender'] === 'Laki-laki') ?> id="male" name="gender" type="radio" value="Laki-laki" />
							<label class="form-check-label" for="male">Laki-laki</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" <?= set_radio('gender', 'Perempuan', $member['gender'] === 'Perempuan') ?> id="female" name="gender" type="radio" value="Perempuan" />
